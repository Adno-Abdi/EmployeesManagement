...
namespace EmployeesAppManager.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,startDate,endDate")] Projects projects)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,startDate,endDate")] Projects projects)
        {
            if (id != projects.Id)
            {
                return NotFound();
